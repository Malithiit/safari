                ...
                <div className="relative z-20 flex flex-col min-h-[calc(100vh)]">
                    <nav className="bg-black h-16 md:h-20 flex justify-between items-center px-6 md:px-12 overflow-visible">
                        ...
                        <div className="hidden md:flex gap-8 items-center justify-end">
                            ...
                            <button onClick={() => handleWhatsApp("Hello, I would like to book a safari/stay.")} className="bg-lime-400 text-black font-semibold border-0 rounded-lg h-10 px-6 hover:bg-lime-500 transition duration-300 text-sm">Book Now</button>
                        </div>
                    ...
                    {menuOpen && (
                        <div className="md:hidden fixed inset-0 bg-black/95 z-40 flex flex-col items-center justify-center gap-8 py-20 animate-in fade-in zoom-in duration-300 overflow-y-auto">
                            ...
                            <button onClick={() => handleWhatsApp("Hello, I would like to book a safari/stay.")} className="bg-lime-400 text-black font-bold border-0 rounded-xl h-12 px-8 mt-4 hover:bg-lime-500 transition duration-300">Book Now</button>
                        </div>
                    )}
                    ...
                    <div className="flex flex-1 flex-col items-center justify-center text-center gap-5 px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 w-full max-w-3xl">
                            <button onClick={() => document.getElementById('safari').scrollIntoView({ behavior: 'smooth' })} style={{ borderRadius: '8px' }} className="bg-lime-400 border-0 text-black font-thin px-6 py-3 md:px-7 md:py-4 text-sm md:text-base w-full">Book Safari</button>
                            <button onClick={() => document.getElementById('rooms').scrollIntoView({ behavior: 'smooth' })} style={{ borderRadius: '8px' }} className="bg-lime-400 border-0 text-black font-thin px-6 py-3 md:px-7 md:py-4 text-sm md:text-base w-full">View Rooms</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        >
            ...
            <div className="absolute bottom-4 right-8 flex gap-2">
                {chooseAreaSlides.map((_, i) => (
                    <div key={i} className={`h-1.5 rounded-full transition-all duration-300 ${curruntSlide === i ? 'w-8 bg-lime-400' : 'w-2 bg-white/50'}`} />
                ))}
            </div>
        </motion.div>
    </div>
...
<div className="bg-white overflow-hidden py-16 md:py-24">
    ...
    >
        ...
        <div className="w-20 h-1.5 bg-lime-400 mt-4 rounded-full"></div>
    </motion.div>
    ...
    <div className="flex flex-col lg:flex-row px-4 sm:px-6 md:px-10 gap-12 lg:gap-20 items-center justify-center max-w-[1400px] mx-auto">
        ...
        {/* Left Side: 4 Images in a Creative Mosaic */}
        <motion.div
            initial={{ x: -100, opacity: 0 }}
            whileInView={{ x: 0, opacity: 1 }}
            transition={{ duration: 0.8 }}
            viewport={{ once: true, amount: 0.1 }}
            className="w-full lg:w-1/2 grid grid-cols-12 grid-rows-12 gap-3 h-[500px] md:h-[650px]"
        >
            {/* Image 1: Top Left Large */}
            <div className="col-start-1 col-end-8 row-start-1 row-end-7 overflow-hidden rounded-2xl shadow-lg">
            ...
            <div className="col-start-8 col-end-13 row-start-2 row-end-6 overflow-hidden rounded-2xl shadow-lg border-4 border-white">
            ...
            <div className="col-start-2 col-end-6 row-start-7 row-end-11 overflow-hidden rounded-2xl shadow-lg border-4 border-white">
            ...
            <div className="col-start-6 col-end-13 row-start-6 row-end-13 overflow-hidden rounded-2xl shadow-lg">
        ...
        >
            <p style={{ fontFamily: 'Poppins, sans-serif' }} className="text-gray-800 text-base md:text-lg leading-relaxed mb-8 text-justify">
               Welcome to one of the world's premier wildlife destinations. Spanning over 30,000 hectares of sun-drenched grasslands and ancient forests, Udawalawe National Park offers an immersive safari experience that rivals the Great Savannahs of Africa. Nestled against the backdrop of the central highlands, this sanctuary is a masterpiece of biodiversity, where nature remains untamed and every turn of the trail reveals a new wonder. <span className="font-bold text-lime-600">30,000 hectares</span>, Udawalawe National Park offers an immersive safari experience that rivals the Great Savannahs of Africa.
            </p>

            <div className="space-y-8">
                <div className="flex gap-5 group">
                    <div className="w-12 h-12 shrink-0 bg-lime-400 text-black flex items-center justify-center rounded-xl font-bold text-xl group-hover:rotate-12 transition-transform">01</div>
                    <div>
                        <h4 style={{ fontFamily: 'Montserrat, sans-serif' }} className="font-bold text-black text-xl">The Gentle Giants</h4>
                        <p className="text-gray-600 text-sm mt-1">Home to 250+ resident Sri Lankan Elephants. Sightings are virtually guaranteed year-round.</p>
                    </div>
                </div>

                <div className="flex gap-5 group">
                    <div className="w-12 h-12 shrink-0 bg-lime-400 text-black flex items-center justify-center rounded-xl font-bold text-xl group-hover:rotate-12 transition-transform">02</div>
                    <div>
                        <h4 style={{ fontFamily: 'Montserrat, sans-serif' }} className="font-bold text-black text-xl">The Wild Residents</h4>
                        <p className="text-gray-600 text-sm mt-1">Spot leopards, sloth bears, wild water buffalo, and spotted deer grazing the savannah.</p>
                    </div>
                </div>

                <div className="flex gap-5 group">
                    <div className="w-12 h-12 shrink-0 bg-lime-400 text-black flex items-center justify-center rounded-xl font-bold text-xl group-hover:rotate-12 transition-transform">03</div>
                    <div>
                        <h4 style={{ fontFamily: 'Montserrat, sans-serif' }} className="font-bold text-black text-xl">Paradise for Birdlife</h4>
                        <p className="text-gray-600 text-sm mt-1">A haven for birdwatchers with over 180 recorded species, including majestic raptors.</p>
                    </div>
                </div>
            </div>
                    ...
                    <div className="flex flex-col lg:flex-row justify-between px-8 md:px-25 pt-10 gap-12 pb-20 ">
                        ...
                        <div className="w-full lg:w-90 bg-[#3A3A3A] p-3 rounded-2xl">
                            ...
                            <div className="bg-[#3A3A3A] px-4 pt-4 pb-2 text-center">
                                <button onClick={() => handleWhatsApp("Hello, I would like to book a stay.")} className="w-full bg-lime-400 text-black text-[12px] font-semibold rounded-md py-2 hover:bg-lime-500 transition"
                                    style={{ fontFamily: 'Montserrat, sans-serif' }}>
                                    BOOK NOW
            ...
            <div className="flex animate-scroll-reviews">
                ...
                {reviewsData.map((review, index) => (
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="flex-shrink-0 w-full sm:w-80 md:w-96 mx-4 bg-gray-50 rounded-3xl p-8 border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-500 group relative"
                    >
                        {/* Quotation Mark Decoration */}
                        <div className="absolute top-6 right-8 text-lime-400/20 text-6xl font-serif">"</div>

                        <div className="flex items-center gap-4 mb-6">
                            <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-lime-400 p-0.5">
                                <img src={review.image} alt={review.name} className="w-full h-full object-cover rounded-full" />
                            </div>
                            <div>
                                <h4 style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: '600' }} className="text-black text-lg">{review.name}</h4>
                        ...
                        <p style={{ fontFamily: 'Poppins, sans-serif' }} className="text-gray-700 leading-relaxed italic">
                            "{review.review}"
                        </p>
                        ...
                        <div className="mt-8 pt-6 border-t border-gray-200 flex justify-between items-center">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <div className="relative overflow-hidden w-32 h-6">
                                    <div className="flex animate-scroll-platforms absolute">
                                        <img src={iconGoogle} className="w-5 h-5 opacity-60 group-hover:opacity-100 transition-opacity flex-shrink-0 mr-3" alt="Google Review" />
                                        <img src={iconFacebook} className="w-5 h-5 opacity-60 group-hover:opacity-100 transition-opacity flex-shrink-0 mr-3" alt="Facebook Review" />
                                        <img src={iconInstagram} className="w-5 h-5 opacity-60 group-hover:opacity-100 transition-opacity flex-shrink-0 mr-3" alt="Instagram Review" />
                                        <img src={icon11} className="w-5 h-5 opacity-60 group-hover:opacity-100 transition-opacity flex-shrink-0 mr-3" alt="TripAdvisor" />
                                        <img src={icon12} className="w-5 h-5 opacity-60 group-hover:opacity-100 transition-opacity flex-shrink-0 mr-3" alt="Booking.com" />
                                        <img src={icon13} className="w-5 h-5 opacity-60 group-hover:opacity-100 transition-opacity flex-shrink-0 mr-3" alt="Trustpilot" />
                        ...
                        >
                            ...
                            >
                                <button
                                    ...
                                    className="bg-lime-400 text-black font-bold text-[16px] px-12 py-3 rounded-xl hover:bg-lime-500 transition duration-300"
                                >
                                    SEND INQUIRE
                                </button>
                            </motion.div>
                ...
                >
                    ...
                    <div className="bg-[#3A3A3A] rounded-2xl p-4 w-full max-w-sm">
                        ...
                        <button
                            ...
                            className="w-full bg-lime-400 text-black text-sm py-2 rounded-xl hover:bg-lime-500 transition"
                        >
                            View Details
                        </button>
                    </div>
                    ...
                    <div className="bg-[#3A3A3A] rounded-2xl p-4 w-full max-w-sm">
                        ...
                        <button
                            ...
                            className="w-full#2eb872 text-black text-sm py-2 rounded-xl hover:bg-lime-500 transition"
                        >
                            View Details
                        </button>
                    </div>
